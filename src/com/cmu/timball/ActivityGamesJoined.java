...
import com.cmu.timball.fragments.FragmentGamesJoined;
import com.cmu.timball.libraries.SuggestionProvider;
import com.cmu.timball.utils.Utils;
import com.google.android.gms.ads.AdView;
import com.cmu.timball.R;

public class ActivityGamesJoined extends ActionBarActivity implements FragmentGamesJoined.OnListSelectedListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		actionbar.setTitle(getString(R.string.page_games_joined));
		
		// Get the intent, verify the action and get the query
	    Intent intent = getIntent();
	    
	   // Get the games joined from the intent
	   
	    email = intent.getStringExtra(ActivityProfile.EXTRA_EMAIL);
	    
     	
	   Bundle bundle = new Bundle();
       bundle.putString(ActivityProfile.EXTRA_EMAIL, email);
       
       FragmentGamesJoined fragObjList = new FragmentGamesJoined();
