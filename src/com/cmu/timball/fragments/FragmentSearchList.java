...
import com.cmu.timball.adapters.AdapterSearchList;
...
public class FragmentSearchList extends Fragment implements OnClickListener{
        ...
        protected void onPostExecute(Void unused) {
        	...
        	if(isAdded()){
	            if(mItems.size() != 0){
	            	...
	            	// Getting adapter
	            	la = new AdapterSearchList(getActivity(), mItems);
	...
	public void getDataFromServer(){
        ...
        try {
        	...
        	json = userFunction.searchByName(mKeyword, mCurrentPage, FragmentHomeLatestMapsList.paramValueItemPerPage);
        	mKeyword = mKeyword.replace("%20", " ");
        	...
        	Log.i("FragmentSearchList", "getDataFromServer: "+e);
        }
